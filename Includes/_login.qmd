...
![](/Includes/1LoginSAML.png){width="3in"}  <!-- says no image but it's all about the include setup -->
...
![](/Includes/2LoginUser.png){width="3in"} 

![](/Includes/3LoginPass.png){width="3in"} 
