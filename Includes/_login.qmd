...
![](/Includes/1LoginSAML.png){width="5in"}  <!-- says no image but it's all about the include setup -->
...
![](/Includes/2LoginUser.png){width="5in"} 

![](/Includes/3LoginPass.png){width="5in"} 
