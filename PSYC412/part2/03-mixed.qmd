...
-   This means that if you put a variable name into the function as in `length(data-set$variable)` it will count how long that variable is -- how many rows there are in the column.
...
-   If you just enter `length(data-set)`, naming some data-set, then the function will return a count of the number of columns in the data-set.
