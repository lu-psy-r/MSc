...
- `#| fig-cap: "Scatterplot showing the potential association between accuracy of comprehension and health literacy"` adds the caption that will be shown next to the plot.
