...
It is *much, much* user friendly, and accurate, than MS Word equation builders.
::::
...
There is, however, a persuasive argument that model information (estimates, etc.) is best communicated visually, see:
