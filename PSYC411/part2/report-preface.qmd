...
::: callout-important
Under construction: come back in a few hours
:::
...
If you want more in-depth guidance or support, we provide detailed *how-to* notes on the work you can expect to do in [the how-to chapter](../part2/how.qmd#sec-how), and an explanation of why we are asking you to do this work in terms of current thinking of best practices in science [the why chapter](../part2/intro.qmd#sec-intro-why).
