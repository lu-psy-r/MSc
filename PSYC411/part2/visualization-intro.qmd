...
::: callout-important
For this class, we are going to hide answer information in collapsible boxes. You can click on the boxes to reveal the answers but, first, try to think what the answers *should be* before you check what I think the answer should be.
:::
