...
2. Find the data! I have put the data here: [stamkou_Study1_edited data.sav](data/wk3/stamkou_Study1_edited data.sav){target="_blank"}, but it is worth looking online to see if you can find the data yourself, to gain further practise of finding data sets.
...
First load in the libraries haven and tidyverse, and then use read_sav to load in the data:
...
- [stamkou_Study1_edited data.sav](data/wk3/stamkou_Study1_edited data.sav){target="_blank"}
