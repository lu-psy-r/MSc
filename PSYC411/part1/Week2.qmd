...
[part 1](ppt/wk2/PSYC411 Lecture week2 part1 handout.pptx), [part 2](ppt/wk2/PSYC411 Lecture week2 part2 handout.pptx), and
[part 3](ppt/wk3/PSYC411 Lecture week2 part3 handout.pptx)
...
Part 2 gives you some more exercises in using R studio to revise last week's material see [this article](https://www.frontiersin.org/journals/psychology/articles/10.3389/fpsyg.2017.00962/full) for the psychology behind learning and memory effects of "spacing".
                        
Part 3 provides you with more practise at looking at others' data and manipulating it.
...
Part 6 provides some extended extra practise in finding and investigating datasets.
...
**** STILL NEED TO FIX THIS - REMOVE EVAL=FALSE BIT ****
::: {.callout-warning icon=false collapse="true"}
## Answer
``` {r eval=FALSE}
library(tidyverse)
...
Go to the webpage of Psychological Science: [https://journals.sagepub.com/home/pss](https://journals.sagepub.com/home/pss).
...
[https://journals.sagepub.com/doi/full/10.1177/0956797615616255](https://journals.sagepub.com/doi/full/10.1177/0956797615616255)
...
47. See if you can find and load the data from one or both of these studies. 
Then have a go at exploring the data - can you recreate the numbers in the paper
(e.g., age and number of participants, mean and sd of the main dependent variable?)

### 2.4.2 Data

Here are links to all the data referred to in this practical:
[PSYC411-shipley-scores-anonymous-17_18.csv]("wk2/PSYC411-shipley-scores-anonymous-17_18.csv")
