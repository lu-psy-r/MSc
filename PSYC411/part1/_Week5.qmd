...
``` {r}
summarydata2_wide <- pivot_wider(summarydata2, names_from = occasion, values_from = ahiTotal)
```
...
t.test(summarydata2_wide$`0`, summarydata2_wide$`1`, paired = TRUE)
...
cohensD( summarydata2_wide$`0`, summarydata2_wide$`1`, method =  "paired")
