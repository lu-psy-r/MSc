...
[part 1](ppt/wk4/PSYC411 Lecture week5 part1 handout.pptx), and [part 2](ppt/wk4/PSYC411 Lecture week5 part2 handout.pptx).
...
dat2 <- read_csv("data/wk2/practical/data/ahicesd.csv")
pinfo <- read_csv("data/wk2/practical/data/participantinfo.csv")
