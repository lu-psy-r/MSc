...
Do the [quick quiz](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=1921435) (not assessed).

Download the lecture slides for [part 2 here](ppt/wk3/PSYC411 Lecture week3 part2 handout.pptx) and [part 3 here](ppt/wk3/PSYC411 Lecture week3 part2 handout.pptx). I haven't put slides for part 1 here because they just said to do the different vocabulary tests.
...
Part 6 is extra: extending your knowledge.

If you've followed a course in R studio before then Parts 1 and 6 will extend your knowledge.
...
```
EmotionCondition `mean(PracticeHappy)` `sd(PracticeHappy)` `mean(VideoHappy, na.rm = T)` sd(VideoHappy, na.…¹
...
7.  Download the data files from last week once again on the vocabulary tests here: [PSYC411-shipley-scores-anonymous-17_18.csv](data/wk2/PSYC411-shipley-scores-anonymous-17_18.zip). 
...
Here is a link to all the data referred to in this practical:
